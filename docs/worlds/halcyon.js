...
(function (root) {
  ...
  MV.defineWorld({
    id: "halcyon",
    tagline: "A gilded motor-yacht, a drowned radio, a storm off the cape — and six guests who all lied about why they came.",
    mode: "whodunit",
    cover: "yacht",
    ...
    dayOneNews: "No one has died yet. The radio has. The coast went next, somewhere between one cocktail and the next, and the bar keeps pouring with an insistence I have learned to distrust. Whatever this reunion is for, it has not started — and everyone aboard is waiting for it to.",
    assignment: {
    ...
    locale: {
      ...
      chronicler: {
        morningOpen: [
          ...
          "By eight bells on the {nth} morning the Halcyon had lost the coast, the radio, and the last pretence of a pleasure cruise.",
        ...
        storm: {
          early: [
            ...
            "The swell ran long and oily, and the glass fell like a man lowering his voice.",
          ],
          mid: [
            ...
            "The wind was a solid thing by now, leaning on the stays, shrieking in the rigging; none of us mentioned it at table.",
          ],
          late: [
        ...
        house: [
          ...
          "The bar went on pouring; it had merely stopped pretending it was celebration.",
        ...
        noDeath: "{alive} of us still came to table, and sat a little farther apart than the day before. Nobody remarked on it.",
        dusk: "Night shut down over the water, black and total. {alive} of us still breathed aboard the Halcyon — and not one of us believed the sea had finished its arithmetic.",
    ...
    cast: [
      { name: "Mr. Ambrose Vane", title: "the Owner", hook: "The shipping magnate whose name is on the hull — and whose past, it turns out, is on the passenger list.",
      ...
      { name: "Mrs. Cynthia Vane", title: "the Owner's Wife", hook: "A hostess with a smile like fresh lacquer, a jealous eye, and one sentence she has been rehearsing for fifteen years.",
      ...
      { name: "Mr. Otto Reinhardt", title: "the Financier", hook: "A moneyman who owes, or is owed by, nearly everyone aboard — only he knows which.",
      ...
      { name: "Miss Dulcie Rae", title: "the Starlet", hook: "A film actress with a newsreel smile, still playing a line somebody else wrote for her long ago.",
      ...
      { name: "Dr. Emeric Sload", title: "the Ship's Doctor", hook: "A soft-voiced ship's physician whose black bag holds things that stop a heart and leave no mark.",
    ...
    mystery: {
      ...
      prose: {
        ...
        searchEmpty: "I turned {room} over while the storm turned the ship. Nothing I could print — only a locker that opened too easily, and the growing certainty that somewhere in all this white steel someone was keeping an account of my curiosity.",
        killerInterview: "I put my questions to Mr. Silva in the wheelhouse, and he answered every one of them with the weather — the barometer falling, the sea getting up, nothing a man could be hanged for. Courteous, exact, perfectly empty. It was only afterward, going down the ladder, that I understood the interview had been running the other way.",
        ...
        observe: "Dinner was a performance in a rolling theatre — the company toasting a reunion not one of them wanted, wine climbing the sides of the glasses with every sea. I kept my notebook under the tablecloth and marked who looked at whom when the ship's bell rang the watch.",
        endings: {
          win: { title: "The Story Breaks", text: "I laid the case out on the saloon table like a hand of cards: the missing key, the oilskin shrine, the blue-ink log under a stopped clock. {killer} listened with the courtesy he had never once dropped, and when I finished he looked, for the first time since we lost the coast, almost at rest. {truth} I filed from the first harbour with a working wire. It will run under my name for the rest of my life — and I lived to see it printed.",
          },
          unproven: { title: "Not Enough Ink", text: "I said his name with nothing to pin it down, and watched the accusation blow off the deck like loose paper. {killer} thanked me for a fascinating theory. The company decided I was hysterical, the sea decided nothing at all, and when we made harbour there was a lawyer waiting on the quay. After that — quietly, patiently — so was he.",
          },
          wrong: { title: "The Wrong Name", text: "I named {accused}, and the appalled silence had teeth in it. Somewhere behind me the real killer freshened a drink, unhurried. I had spent the one accusation a correspondent gets, and every soul aboard knew it — and the sea keeps whatever the night hands over the rail.",
          },
          ...
          empty: { title: "Two Souls Aboard", text: "By the time I could prove anything, there was no one left alive to accuse — and no one left to read the story back to. The Halcyon made her harbour with two souls aboard, and only one of us was ever going to step off.",
          },
          lastDawn: { title: "The Coast Comes Back", text: "The storm lifted, the coast came back, and a pilot boat came out to meet us — my notebook full of suspicion and empty of proof. On the quay the company scattered into taxis and lawyers, and somewhere among them went the killer, with my six days folded neatly in a breast pocket.",
          },
        },
      },
      herrings: {
        "Mr. Ambrose Vane": {
          clue: "Vane received me in the owner's stateroom like a press conference of one. 'A reunion, Miss Frost. Men of my position honour their anniversaries.' He said it twice, in the tone men keep for alibis. Every photograph on that panelling has been freshly rehung, and one hook stands empty. Whatever hung there came down before he let a journalist up the gangway.",
        ...
        "Mrs. Cynthia Vane": {
          clue: "'My husband is a great man,' Mrs. Vane told me, before I had asked her anything at all. 'You may print that.' The smile never moved; the gloves stayed on through the whole interview, and her eyes went to the starlet twice, coming back harder each time. Fifteen years ago she gave an inquest one sentence about where her husband spent a night of fog — and she has kept it polished ever since.",
          alibi: "But Cynthia Vane does not go below the waterline — the stewardesses swear she has never once taken the aft companionway — and two of them can place her at her dressing table through every hour that matters. Her sins are of the signed and witnessed kind.",
        },
        "Mr. Otto Reinhardt": {
          clue: "Reinhardt talked to me the way he talks to auditors: charmingly, precisely, one drawer always locked. 'A claim? There are always claims. That one was settled to everyone's satisfaction.' Everyone's, I noted, but the drowned's. A Mariners' Mutual file on a lost fishing boat crossed his desk once — settled fast, sealed faster, no exhibits — and his initials are still on it. Two passengers aboard are worth more to him dead than alive, and he knows the figures to the shilling.",
